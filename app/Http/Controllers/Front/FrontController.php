...
//        dd($lpost);
        ...
        return view ('front.home',compact('about','featured_product','product','banner','products','general','link','lpost','partner','pcategories','portfolios','services'));
...
//            'data'=>   compact('about','banner','general','link','lpost','partner','pcategories','portfolio','service')  ,] , 200);
    ...
    public function about()
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
       return view ('front.about',compact('about','banner','portfolios','services','product','faq','general','link','lpost','partner','team'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
//            'data'=>   compact('about','faq','general','link','lpost','partner','team')  ,] , 200);
    ...
    public function contact()
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
        return view ('front.contact',compact('about','banner','portfolios','services','product','faq','general','link','lpost','partner','team'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
...
//            'data'=>   compact('general','link','lpost','testi')  ,] , 200);
    ...
    public function service()
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
        return view ('front.service',compact('about','general','link','lpost','services','banner','portfolios','product'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
//            'data'=>   compact('general','link','lpost','service')  ,] , 200);
    ...
    public function serviceshow($slug)
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
       return view ('front.serviceshow',compact('general','about','link','lpost','service','services','banner','product','portfolios'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
//            'data'=>   compact('general','link','lpost','service')  ,] , 200);
    ...
    public function product()
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
        return view ('front.product',compact('about','general','link','lpost','services','banner','portfolios','product'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
//            'data'=>   compact('general','link','lpost','service')  ,] , 200);
    ...
    public function productshow($slug)
    {
        ...
        $portfolios = Portfolio::all();
        $product=Product::all();
        return view ('front.productshow',compact('general','prod','about','link','lpost','services','banner','product','portfolios'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
...
//        dd($portfolio);
        ...
        $portfolios = Portfolio::all();
        $about = About::find(1);
        return view ('front.portfolioshow',compact('general','product','services','portfolios','about','link','lpost','portfolio'));
//        return response()->json([
//            'status' => 'sucssess' ,
//            'statusCode' => '200' ,
//            'error' => null ,
